  ...
  return (
    <section className="min-h-[670px] w-full mb-12">
      ...
      <div className="absolute inset-0 flex items-center justify-center flex-col">
        ...
        <p className="font-poppins font-medium text-white text-5xl">
          View Properties
        </p>
      </div>
      {/* Bottom Switches */}
      <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 flex items-center justify-center flex-col">
        <button className="w-[247px] h-[66px] font-semibold text-xl bg-white text-[#5E2D4F] rounded-tr-lg rounded-tl-lg flex justify-center items-center gap-3 cursor-pointer">
          {" "}
          HavenAI{" "}
          <Image
        ...
        <button className="w-[527px] h-[77px] font-semibold text-xl bg-[#5E2D4F] text-white rounded-lg flex justify-center items-center gap-3 cursor-pointer">
          <Image
